# YOLOv11 Dermatology Detection System

## Body

YOLOv11 Dermatology Identification System based on Deep Learning YOLOv11's Dermatology Identification and Detection System (YOLOv11+YOLO dataset + UI interface + login registration interface + Python project source code + model)

nc: 7 classes,
Names: ['Bowen's Disease', 'Basal Cell Carcinoma', 'Benign Keratosis Lesions', 'Dermatofibroma', 'Melanoma', 'Melanocytic Nevus', 'Vascular Lesions'],
Dataset quantity: training set 681 images, validation set 97 images, test set 195 images.
